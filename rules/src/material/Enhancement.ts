...
export const enhancementsAnatomy: Record<Enhancement, GardenAnatomy> = {
  [Enhancement.Lion]: { main: Animal.Lion },
  [Enhancement.Monkey]: { main: Animal.Monkey },
  [Enhancement.Peacock]: { main: Animal.Peacock },
  ...
  [Enhancement.LionCrown]: { main: Animal.Lion, crown: true },
  [Enhancement.MonkeyCrown]: { main: Animal.Monkey, crown: true },
  ...
  [Enhancement.MonkeyIrrigation]: { main: Animal.Monkey, irrigation: true },
  [Enhancement.PeacockIrrigation]: { main: Animal.Peacock, irrigation: true },
